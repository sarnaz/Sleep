...
public class StreakPage extends UIViewPage {
    ...
    protected void setUp(Page page) {
        ...
        MyText.putTextCentred(page, new int[] {400, 375}, 100, currentStreak, ColourUtil.accentColour, "Helvetica", Font.BOLD);

        if(Database.getStreak() <= 1){
            MyText.putTextCentred(page, new int[] {400, 410}, 30, "Day", ColourUtil.accentColour, "Helvetica", Font.BOLD);
        } else {
            MyText.putTextCentred(page, new int[] {400, 410}, 30, "Days", ColourUtil.accentColour, "Helvetica", Font.BOLD);
        }
