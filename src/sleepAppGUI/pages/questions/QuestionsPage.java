...
abstract public class QuestionsPage extends UIViewPage {
    ...
    protected void setUp(Page page) {
        ...
        // behind frame
        new MyRectangle(page, new int[] {120, 170}, new int[] {560, 210}, 30, ColourUtil.foregroundColour);
        // hide bed
        new MyRectangle(page, new int[] {185, 15}, new int[] {150, 145}, ColourUtil.backgroundColour);
    }
}
