...
public class ExerciseGraph extends GraphPage{
    ...
    protected void setUp(Page page) {
        ...
        MyImage water = new MyImage(page, new int[] {300, 10}, new int[] {500, 100}, "exercise", true);
        MyButton homebutton = new MyButton(page, "home", new int[] {565, 30}, new int[] {635, 100}, "home")
        {
            public void isClicked()
            {
                ExerciseGraph.this.push(new HomePage());
        ...
        MyButton backbutton = new MyButton(page, "back", new int[] {150, 30}, new int[] {220, 100}, "back")
        {
            public void isClicked()
            {
                ExerciseGraph.this.push(new GraphVisual());
                System.out.println("graph");
            }
        };
        MyBar exercise_bar = new MyBar(page, new int[] {80,150}, new int[] {380,450});
        MyScatter exercise_scatter = new MyScatter(page, new int[] {400,150}, new int[] {700,450});
